...
const RichTextEditorWithVideoModule = () => {
    ...
    return <>
        <Helmet>
            <meta http-equiv="Content-Security-Policy" content="frame-src 'self' *.youtube.com *.vimeo.com; img-src 'self' *.youtube.com *.vimeo.com *.ytimg.com *.vimeocdn.com blob: data:;" />
        </Helmet>
